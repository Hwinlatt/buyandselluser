        ...
        <div class="row mt-3">
            ...
            <div class="col-md-8 card mb-3">
                <div class="card-header text-center">
                    <img src="/img/b-logo.ico" class="rounded rounded-circle me-1" height="60"
                        alt="MDB Logo" /> Register Form
                </div>
                <div class="card-body">
                   <div class="row">
                    ...
                    <div class="mb-3 col-sm-6">
                        ...
                        <input :class="{ 'is-invalid': errors.confirmed_password }" 
                           placeholder="Enter Confirm Password" v-model="formData.confirmed_password" type="passsword" id="form3Example5"
                    ...
                    <div class=" mb-2 col-sm-6">
                        ...
                        <select :class="{ 'is-invalid': errors.region }" v-model="formData.region"
                            ...
                            <option :value="region.name" class="m-1 text-capitalize" v-for="(region, index) in defaultVar.region"
                                :key="index">
                                {{ region.name }}</option>
                        </select>
                    ...
                    <div class="mb-3 col-sm-6">
                        ...
                        <select :class="{ 'is-invalid': errors.city }" v-model="formData.city" id="cityInput"
                            ...
                            <option :value="city.city" class="m-1 text-capitalize" v-for="(city, index) in filterCities" :key="index">
                                {{ city.city }}
                            </option>
                        </select>
                    ...
                    <button  @click="singUpProcess()" :disabled="!singUpBtnStatus"  v-else type="submit" class="btn btn-primary btn-block my-3">
                        Sign up
                    </button>
                    <!-- Register buttons -->
